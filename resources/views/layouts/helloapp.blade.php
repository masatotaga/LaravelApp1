...
<body>
    ...
    <div class="page-header wrapper">
        ...
        <nav>
            <ul class="main-nav">
                <li><input type="button" class="btn btn-primary" onclick="location.href='{{url('/')}}'" value="ホーム"></li>
                <li><input type="button" class="btn btn-primary" onclick="location.href='{{ route('register') }}'" value="登録"></li>
                <li><input type="button" class="btn btn-primary" onclick="location.href='{{url('/login')}}'" value="ログイン"></li>
            </ul>
        </nav>
    </div>
    @else
    <div class="page-header wrapper">
        ...
        <nav>
            <ul class="main-nav">
                ...
                <li class="nav-item dropdown">
                  <input type="button" value="ログアウト"  class="btn btn-primary"
