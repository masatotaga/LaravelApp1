...
<head>
    ...
    .content3 {border:double 4px #ccc; margin:10px; padding:10px; background-color:#fff888;}
    ...
    /*card*/
    .card2{display: flex; justify-content: space-evenly; flex-wrap: wrap;}
    ...
    .card2-header {padding: 0.75rem 1.25rem; margin-bottom: 0; background-color: rgba(0, 0, 0, 0.03); border-bottom: 1px solid rgba(0, 0, 0, 0.125);}
        .card2 li{list-style: none;margin-top 5px;}
        .float-right{text-align:left; float: left !important; text-align: left; margin-top: 5px; margin-left: 0px;}
    </style>
</head>
<body>
    @guest
    <div class="page-header wrapper">
        ...
        <nav>
            <ul class="main-nav">
                <li><input type="button" class="btn btn-primary" onclick="location.href='{{url('/')}}'" value="@yield('navtitle0')"></li>
                <li>@yield('navtitle1')</li>
                <li><input type="button" class="btn btn-primary" onclick="location.href='{{url('/login')}}'" value="@yield('navtitle3')"></li>
            </ul>
        </nav>
    </div>
    @else
        ...
        <nav>
            <ul class="main-nav">
                <!--<li class="nav-item dropdown">
                    <input type="button" id="navbarDropdown" class="nav-link dropdown-toggle" onclick="location.href='#'" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre value="{{ Auth::user()->name }}さん">
                </li>-->
                ...
                <li class="nav-item dropdown">
                    <button onclick="location.href='{{route('posts.page')}}'" class="btn btn-primary">投稿</button>
                </li>
